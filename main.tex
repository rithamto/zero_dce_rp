...
\title{\textbf{Nghiên cứu về Thuật toán Zero-DCE: Tăng cường Ảnh Thiếu sáng bằng Phương pháp Ước lượng Đường cong Không tham chiếu}}
\author{Báo cáo Kỹ thuật \\ \small Lĩnh vực: Thị giác Máy tính và Xử lý Ảnh}
\date{\today}
...
\section{Tác động Xã hội và Đạo đức}
Công nghệ LLIE như Zero-DCE có tác động lớn đến quyền riêng tư. Việc có thể nhìn xuyên thấu bóng tối một cách dễ dàng đặt ra những câu hỏi về việc sử dụng camera giám sát trong đời sống. Tuy nhiên, ở mặt tích cực, nó hỗ trợ đắc lực cho cứu hộ ban đêm, an toàn giao thông và nâng cao chất lượng lưu trữ hình ảnh lịch sử.
